...
input ENUM_ZA_MODE    InpMode           = ZA_RSI2;   // Strategie
...
input int  InpStartHour           = 0;    // Debut des entrees
input int  InpEndHour             = 24;   // Fin des entrees
...
input group "=== Divers ==="
input ulong InpMagic              = 41410011; // Numero magique
