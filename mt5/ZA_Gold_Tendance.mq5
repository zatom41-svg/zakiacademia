//+------------------------------------------------------------------+
//|                                             ZA_Gold_Tendance.mq5 |
//| ZA Gold Tendance : suit la tendance de l'or en D1 (reglages par defaut) |
//|                                                                  |
//|  Logique :                                                       |
...
input ENUM_ZA_MODE    InpMode           = ZA_TREND;  // Strategie
input ENUM_TIMEFRAMES InpTimeframe      = PERIOD_D1; // Unite de temps
...
input bool            InpAllowShort     = false;     // Autoriser les ventes (non : achat seulement)
...
input bool InpCloseBeforeWeekend  = false; // Fermer les positions le vendredi
input int  InpFridayCloseHour     = 20;   // Heure de fermeture du vendredi

input group "=== Divers ==="
input ulong InpMagic              = 41410012; // Numero magique
